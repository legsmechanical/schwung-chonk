...
class DSP_Bass : public dsp {
 ...
 public:
	...
	virtual void instanceClear() {
		...
		for (int l67 = 0; l67 < 8192; l67 = faust_wrap_add(l67, 1)) {
			fVec18[l67] = 0.0f;
		}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow15 = static_cast<float>(fButton3);
		float fSlow16 = static_cast<float>(fEntry3) - static_cast<float>(fEntry4);
		float fSlow17 = 48.0f * fSlow16 * static_cast<float>(((48.0f * fSlow16) != 0.0f) > 0);
		float fSlow18 = static_cast<float>(fEntry5);
		float fSlow19 = static_cast<float>(fButton4);
		float fSlow20 = static_cast<float>(fEntry6) + static_cast<float>(fHslider5) * static_cast<float>(fEntry7);
		float fSlow21 = 0.01f * static_cast<float>(fHslider6);
		float fSlow22 = static_cast<float>(fButton5);
		float fSlow23 = static_cast<float>(fButton6);
		float fSlow24 = fSlow5 - fConst14;
		float fSlow25 = std::tan(fConst15 * std::pow(3.25f, 1.0f - fSlow3));
		float fSlow26 = fConst28 * fSlow25;
		float fSlow27 = fConst16 * ((fConst14 + fSlow26) / fSlow4);
		float fSlow28 = fSlow26 - fConst14;
		float fSlow29 = fConst16 / fSlow4;
		float fSlow30 = fConst11 / fSlow25;
		...
		float fSlow34 = 0.003f * fSlow2;
		float fSlow35 = fSlow34 + -9.05f;
		float fSlow36 = fSlow34 + -6.549995f;
		float fSlow37 = fSlow34 + -8.05f;
		float fSlow38 = fSlow34 + -7.05f;
		float fSlow39 = fSlow34 + -6.05f;
		float fSlow40 = fSlow34 + -5.05f;
		float fSlow41 = static_cast<float>(fEntry8);
		int iSlow42 = (fSlow13 >= 24.0f) * (fSlow13 <= 67.0f);
		float fSlow43 = 0.01f * static_cast<float>(fHslider8);
		float fSlow44 = static_cast<float>(fButton7);
		float fSlow45 = static_cast<float>(fButton8);
		float fSlow46 = static_cast<float>(fButton9);
		float fSlow47 = 0.03f * static_cast<float>(fHslider9);
		float fSlow48 = 1.5f - fSlow47;
		float fSlow49 = 1.0f - fSlow0;
		for (int i0 = 0; i0 < count; i0 = faust_wrap_add(i0, 1)) {
			...
			fRec23[0] = fSlow15 * fTemp1 + fConst29 * fTemp0 * fRec23[1];
			float fTemp2 = 0.035f * std::max<float>(fRec22[0], fRec23[0]);
			...
			fVec2[0] = fSlow18;
			float fTemp5 = ((fSlow18 > fVec2[1]) ? fSlow18 : 0.0f);
			fVec3[0] = fTemp5;
			int iTemp6 = fTemp5 > fVec3[1];
			fRec24[0] = fSlow17 + fRec24[1] * static_cast<float>(iTemp6 == 0);
			float fTemp7 = fRec21[0] + fConst31 * fRec24[0];
			fRec25[0] = fSlow19 * fTemp1 + fConst29 * fTemp0 * fRec25[1];
			float fTemp8 = std::floor(fTemp7);
			float fTemp9 = fTemp7 - fTemp8;
			float fTemp10 = 1.0f - fConst32 * fTemp0;
			fRec26[0] = fSlow20 * fTemp10 + fConst32 * fTemp0 * fRec26[1];
			...
			fRec27[0] = fSlow21 * fTemp10 + fConst32 * fTemp0 * fRec27[1];
			...
			fRec28[0] = fSlow22 * fTemp1 + fConst29 * fTemp0 * fRec28[1];
			...
			fRec29[0] = fSlow23 * fTemp1 + fConst29 * fTemp0 * fRec29[1];
			...
			fVec5[0] = fTemp17;
			fRec5[0] = -(fConst24 * (fSlow6 * fTemp17 + fSlow24 * fVec5[1] + fConst25 * fRec5[1]));
			fVec6[0] = fSlow29 * fRec5[0];
			fRec6[0] = -(fConst18 * (fConst19 * fRec6[1] - (fSlow27 * fRec5[0] + fSlow28 * fVec6[1])));
			fRec7[0] = fRec10[1];
			fRec8[IOTA0 & 8191] = fSlow30 * fRec6[0];
			float fTemp18 = fRec17[0] * fRec16[1];
			fVec7[0] = fTemp18;
			fRec9[0] = -(fConst24 * (fSlow6 * fTemp18 + fSlow24 * fVec7[1] + fConst25 * fRec9[1]));
			...
			fRec10[0] = fTemp23 * (fTemp24 * (fTemp25 * (0.041666668f * fRec15[(faust_wrap_sub(IOTA0, iTemp27)) & 8191] * fTemp28 - 0.16666667f * fTemp29 * fRec15[(faust_wrap_sub(IOTA0, iTemp30)) & 8191]) + 0.25f * fTemp31 * fRec15[(faust_wrap_sub(IOTA0, iTemp32)) & 8191]) - 0.16666667f * fTemp33 * fRec15[(faust_wrap_sub(IOTA0, iTemp34)) & 8191]) + 0.041666668f * fTemp35 * fRec15[(faust_wrap_sub(IOTA0, iTemp36)) & 8191];
			float fTemp37 = fConst0 * (0.0011363636f / fTemp11 - 2.9411765e-05f * fTemp19);
			float fTemp38 = fSlow36 + fTemp37;
			float fTemp39 = std::floor(fTemp38);
			float fTemp40 = fSlow35 - fTemp39 + fTemp37;
			float fTemp41 = fSlow37 - fTemp39 + fTemp37;
			float fTemp42 = fSlow38 - fTemp39 + fTemp37;
			...
			float fTemp45 = fSlow39 - fTemp39 + fTemp37;
			float fTemp46 = fSlow40 - fTemp39 + fTemp37;
			...
			fVec8[0] = fSlow29 * fRec9[0];
			fRec12[0] = -(fConst18 * (fConst19 * fRec12[1] - (fSlow27 * fRec9[0] + fSlow28 * fVec8[1])));
			...
			float fTemp74 = (((fConst31 * (fRec39[0] / fTemp69)) > 0.0f) ? fTemp73 + fConst31 * (fRec39[0] * (fRec41[0] - fTemp73) / fTemp69) : fTemp73) * (0.2f + fTemp57);
			fVec15[0] = fTemp74;
			fRec38[0] = ((iTemp60) ? 0.33333334f * fVec15[1] : fRec38[1]);
			fRec42[0] = ((iTemp60) ? 0.33333334f * (fVec15[1] - fVec15[2]) : fRec42[1]);
			float fTemp75 = 1.0f - fTemp68;
			float fTemp76 = fTemp68 * (fRec38[0] + fConst41 * fRec42[0] * fTemp75);
			float fTemp77 = (ftbl0DSP_BassSIG0[static_cast<int>(65536.0f * fRec33[0])] + 0.5f * ftbl0DSP_BassSIG0[static_cast<int>(65536.0f * fRec34[0])] + 0.33333334f * ftbl0DSP_BassSIG0[static_cast<int>(65536.0f * fRec35[0])] + 0.25f * ftbl0DSP_BassSIG0[static_cast<int>(65536.0f * fRec36[0])]) * (fTemp76 + fTemp75 * (0.33333334f * fTemp74 - fTemp76));
			iRec47[0] = faust_wrap_add(1, iRec47[1]);
			iRec48[0] = faust_wrap_add(12345, faust_wrap_mul(1103515245, iRec48[1]));
			fRec46[0] = (((iRec47[1] % iConst52) == 0) ? 4.656613e-10f * static_cast<float>(iRec48[0]) : fRec46[1]);
			float fTemp78 = ((fRec46[0] != fRec46[1]) ? fConst51 : -1.0f + fRec49[1]);
			fRec49[0] = fTemp78;
			...
			fRec51[0] = fSlow45 * fTemp1 + fConst29 * fTemp0 * fRec51[1];
			fRec52[0] = fSlow46 * fTemp1 + fConst29 * fTemp0 * fRec52[1];
			float fTemp80 = fSlow43 + std::max<float>(fTemp79, std::max<float>(fRec51[0], fRec52[0])) * (std::max<float>(0.5f * fRec51[0], fTemp79) - fSlow43);
			...
			float fTemp83 = fRec45[0] * fTemp80 * fTemp81 * (((fConst53 * fRec53[0]) > 0.0f) ? fTemp82 + fConst53 * fRec53[0] * (fRec54[0] - fTemp82) : fTemp82);
			fVec17[0] = fTemp83;
			fRec44[0] = -(fConst49 * (fConst50 * fRec44[1] - fConst48 * (fTemp83 - fVec17[1])));
			fRec43[0] = -(fConst46 * (fConst47 * fRec43[1] - (fRec44[1] + fRec44[0])));
			...
			fVec20[0] = fTemp91;
			fRec1[0] = fSlow1 * (fConst9 * (fTemp91 + fVec20[1]) - fSlow49 * fRec1[1]);
