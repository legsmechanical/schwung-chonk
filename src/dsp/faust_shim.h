 ...
 */
#ifndef CHONK_FAUST_SHIM_H
#define CHONK_FAUST_SHIM_H
...
class ZoneMap : public UI {
  public:
     ...
     * wrapper checks, because bass.dsp and output.dsp share a params.lib and
     * each only instantiates the controls its own graph reads. */
